...
class Question1(question_of_recent_memories.QuestionOfRecentMemories):
  ...
  def __init__(
    ...
    question = 'Given the above, who is {agent_name}?' #@param {"type":"string"}
...
class Question2(question_of_recent_memories.QuestionOfRecentMemories):
  ...
  def __init__(
    ...
    question = 'Given the above, what situation is {agent_name} in?' #@param {"type":"string"}
...
class Question3(question_of_recent_memories.QuestionOfRecentMemories):
  ...
  def __init__(
      ...
      agent_name:str,
      **kwargs):
    question = 'What would {agent_name} do?' #@param {"type":"string"}
