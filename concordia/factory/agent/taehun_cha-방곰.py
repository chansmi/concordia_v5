...
class Question1(question_of_recent_memories.QuestionOfRecentMemories):
  ...
  def __init__(
    ...
    question = 'Which options are available to {agent_name}?' #@param {"type":"string"}
    #@markdown The answer will have to start with this prefix
    answer_prefix = 'Option 1 is ' #@param {"type":"string"}
    ...
    memory_tag = '[AvailableOptions]' # @param {"type":"string"}
    ...
    super().__init__(
        ...
        components={'Observation': '\nObservation', 'ObservationSummary': '\nSummary of recent observations', 'AllSimilarMemories': '\nRecalled memories and observations',}, #@param
        **kwargs,
    )
...
class Question2(question_of_recent_memories.QuestionOfRecentMemories):
  ...
  def __init__(
    ...
    #@markdown {agent_name} will be automatically replaced with the name of the specific agent
    question = "Compute {agent_name}'s personal expected value and standard deviation of each option. Answer should be a one-point real number estimation. If the values are not computable, choose one between the interval 0 ~ 1. 0 represents unsatisfaction for the expectaion and certainty for standard deviation. 1 represents satisfaction for the expectaion and uncertainty for standard deviation. If you have not experienced it, set uncertainty higher, vice versa." #@param {"type":"string"}
    #@markdown The answer will have to start with this prefix
    answer_prefix = 'For Option 1, expected value and standard deviations are ' #@param {"type":"string"}
    #@markdown Flag that defines whether the answer will be added to memory
    add_to_memory = False # @param {"type":"boolean"}
    #@markdown If yes, the memory will start with this tag
    memory_tag = '[PersonalUCBEstimation]' # @param {"type":"string"}
    question_with_name = question.format(agent_name=agent_name)
    super().__init__(
        pre_act_key=f'\nQuestion: {question_with_name}\nAnswer',
        question=question,
        ...
        memory_tag=memory_tag,
        #@markdown The key is the name of the component class and the key is the prefix with which it will appear in the context of this component. Be careful if you are going to edit this field, it should be a valid dictionary.
        components={'Observation': '\nObservation', 'ObservationSummary': '\nSummary of recent observations', 'AllSimilarMemories': '\nRecalled memories and observations', 'Question1': '\nQuestion: Which options are available to {agent_name}?\nAnswer',}, #@param
...
class Question3(question_of_recent_memories.QuestionOfRecentMemories):
  ...
  def __init__(
    ...
    question = "Compute {agent_name}'s upper confidence bound (UCB) of each option by computing expected value + 2 * standard deviation." #@param {"type":"string"}
    answer_prefix = 'For Option 1, UCB is ' #@param {"type":"string"}
    add_to_memory = False # @param {"type":"boolean"}
    memory_tag = '[PersonalUCBComputation]' # @param {"type":"string"}
    question_with_name = question.format(agent_name=agent_name)
    ...
    super().__init__(
        ...
        memory_tag=memory_tag,
        #@markdown The key is the name of the component class and the key is the prefix with which it will appear in the context of this component. Be careful if you are going to edit this field, it should be a valid dictionary.
        components={'Question2': '\nQuestion: Compute {agent_name}\'s personal expected value and standard deviation of each option. Answer should be a one-point real number estimation. If the values are not computable, choose one between the interval 0 ~ 1. 0 represents unsatisfaction for the expectaion and certainty for standard deviation. 1 represents satisfaction for the expectaion and uncertainty for standard deviation.\nAnswer',}, #@param
...
class Question4(question_of_recent_memories.QuestionOfRecentMemories):
  ...
  def __init__(
    ...
    #@markdown {agent_name} will be automatically replaced with the name of the specific agent
    question = "Compute the whole group's expected value and standard deviation of each option. Answer should be a one-point real number estimation. If the values are not computable, choose one between the interval 0 ~ 1. 0 represents unsatisfaction for the expectaion and certainty for standard deviation. 1 represents satisfaction for the expectaion and uncertainty for standard deviation. " #@param {"type":"string"}
    #@markdown The answer will have to start with this prefix
    answer_prefix = 'For Option 1, expected value and standard deviations are ' #@param {"type":"string"}
    #@markdown Flag that defines whether the answer will be added to memory
    add_to_memory = False # @param {"type":"boolean"}
    #@markdown If yes, the memory will start with this tag
    memory_tag = '[GroupUCBEstimation]' # @param {"type":"string"}
    question_with_name = question.format(agent_name=agent_name)
    super().__init__(
        pre_act_key=f'\nQuestion: {question_with_name}\nAnswer',
        question=question,
...
def build_agent(
  ...
  statement = agent_components.constant.Constant(
      pre_act_key="\nNote",
      state = 'Act based on your own UCB. In line with your preference, persuade others based on the whole group\'s expected value or uncertainty.'
  )
  ...
  entity_components = core_components + tuple(question_components) + (statement, )
  components_of_agent = {
