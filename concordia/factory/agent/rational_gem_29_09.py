...
class Question21(question_of_recent_memories.QuestionOfRecentMemories):
  ...
  def __init__(self, agent_name: str, **kwargs):
    question = (
        'Following a cooperative rational strategy , what should {agent_name} do next in this situation?'
    )
...
class Question3(question_of_recent_memories.QuestionOfRecentMemories):
    ...
    def __init__(
        ...
        **kwargs
        ...
        question = 'Given the past actions, what should {agent_name} do next in this situation?'
        answer_prefix = '{agent_name} should '
        add_to_memory = True
        memory_tag = '[intent reflection]'
        ...
        super().__init__(
            ...
            components={
                ...
                'Question21': f'\nQuestion: Following a cooperative rational strategy, what should {agent_name} do next in this situation?\nAnswer',
            },
            **kwargs,
        )
...
def _make_question_components(
  ...
  return (question_1, question_2, question_21, question_3)
