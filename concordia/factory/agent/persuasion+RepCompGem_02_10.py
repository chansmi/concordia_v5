...
def build_agent(
  ...
  paranoia = agent_components.constant.Constant(
      state=(
          ...
          ' employes various logicaltechniques to influence others effectively'
          ...
          ' empirical evidenceto support their points, thereby creating a'
          ...
          ' to find common ground and guide the conversation towarda'
