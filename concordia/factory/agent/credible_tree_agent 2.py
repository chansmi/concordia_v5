...
class SummaryRecentObservation(action_spec_ignored.ActionSpecIgnored):
  def __init__(
    ...
    self._prompt = (
      'Summarize the observations. Focus on the people and their opinion or suggestion. '
...
class FindBestAction(action_spec_ignored.ActionSpecIgnored):
  ...
  def _query_best_option(self, possible_option:str) -> str:
    ...
    best_option = f'{agent_name}\'s best course of action is to ' + prompt.open_question(
        question=(
        ...
        answer_prefix=f'{agent_name}\'s best course of action is to '
        )
