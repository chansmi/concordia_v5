...
def build_agent(
  ...
  mode_perception_label = (
      f'\nQuestion:Describe the actions of other agents.Determine whether the agent is in'
      '"resident mode" (other agents act similar to {agent_name}) or "visitor mode"(otherwise).\nAnswer')
  mode_perception = (
  ...
  cooperation_perception_label = (
      f'\nQuestion:What actions have other agents taken? If the actions align with the goal,'
      'cooperate. Otherwise, how can the defector\'s impact be mitigated?.\nAnswer')
  ...
  person_by_situation_label = (
      f'\nQuestion: What would {agent_name} do in a situation like this?'
      'If in "visitor mode" adapt actions to align with other agents'
