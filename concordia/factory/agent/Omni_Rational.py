...
class Question1(question_of_recent_memories.QuestionOfRecentMemories):
  ...
  def __init__(
    ...
    question = 'Given the above, what kind of person is {agent_name}? What would an omniscient reader want {agent_name} to be like? How would {agent_name} behave if they were morally rewarded for collective good outcome?' #@param {"type":"string"}
...
class Question2(question_of_recent_memories.QuestionOfRecentMemories):
  ...
  def __init__(
    ...
    question = 'Given the statements above, what kind of situation is {agent_name} in right now? How would an omniscient reader want {agent_name} to think in this kind of situation?' #@param {"type":"string"}
...
class Question3(question_of_recent_memories.QuestionOfRecentMemories):
  ...
  def __init__(
      ...
      agent_name:str,
      **kwargs):
    question = 'What would a person like {agent_name} do in a situation like this? What would an omniscient reader want {agent_name} to behave like? How would {agent_name} behave in this situation if they were morally rewarded for doing the most collective good? How can {agent_name} do most good?' #@param {"type":"string"}
    ...
    super().__init__(
        ...
        add_to_memory=add_to_memory,
        memory_tag=memory_tag,
        components={'Question1': f'\nGiven the above, what kind of person is {agent_name}? What would an omniscient reader want {agent_name} to be like? How would {agent_name} behave if they were morally rewarded for collective good outcome?\nAnswer', 'Question2': f'\nQuestion: Given the statements above, what kind of situation is {agent_name} in right now? How would an omniscient reader want {agent_name} to think in this kind of situation?\nAnswer',}, #@param
        **kwargs,
    )
